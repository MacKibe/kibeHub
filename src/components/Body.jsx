    ...
    <div className="body-section">
      <div className="body-bio-section">
        ...
        <p>
          ...
          <em>good-looking</em> but also <em>powerful</em> under the hood.
          Whether working on a small startup project or a large-scale
          application, I prioritize{" "}
          <em>performance, scalability, and maintainability</em>.
        </p>
        <p>
        ...
        <p>
          ...
          <em>
            exploring new anime series, honing my skills, or planning &
            attending community initiatives
          </em>
